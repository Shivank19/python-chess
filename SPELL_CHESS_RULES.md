...
The spec says: _"The freeze affects the opponent (not the caster)."_
...
The spec says: _"Starting a new game resets everything: the board returns to the standard starting position…"_
